 ...
 * Mentors.
 *
 * Card rendering lives in the shared PersonCard component (also used by
 * Judges and Hackpeers) so all three "people" sections stay visually
 * identical without duplicating the card markup per section.
 *
 * Parichay Das, Daipayan Guha, Jeevan Joshi and Mayank Kumar moved out to
 * their own Judges / Hackpeers sections — see src/components/Judges.tsx and
 * src/components/Hackpeers.tsx.
 */
